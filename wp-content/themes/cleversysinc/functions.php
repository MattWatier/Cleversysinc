...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		...
		array (
			0 => 
			array (
				'key' => 'field_5053b0d33a3ce',
				'label' => 'Documents',
				'name' => 'documents',
				'type' => 'repeater',
				'instructions' => 'Select any documents that are associated with this product',
				'required' => '0',
				'sub_fields' => 
				array (
					0 => 
					array (
						'key' => 'field_5053b0d33b371',
			...
			1 => 
			array (
				'key' => 'field_5053b0d33d741',
				'label' => 'Hero Images',
				'name' => 'image',
				'type' => 'image',
				'instructions' => 'Select the hero Image for this product. It will be the large image on the page.',
				'required' => '0',
				'save_format' => 'object',
