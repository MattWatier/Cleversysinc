...
function custom_post_example() { 
	...
	register_post_type( 'cs_gallery_panel', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Gallery Panels', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Gallery Panel', 'post type singular name'), /* This is the individual type */
			'add_new' => __('Add Panel', 'gallery panel item'), /* The add new menu item */
			'add_new_item' => __('Add New Panel to Gallery'), /* Add New Display Title */
			'edit' => __( 'Edit' ), /* Edit Dialog */
			'edit_item' => __('Edit Panel'), /* Edit Display Title */
			'new_item' => __('New Gallery Panel'), /* New Display Title */
			'view_item' => __('View Gallery Paenl'), /* View Display Title */
			'search_items' => __('Search Gallery Panels'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the example of a gallery panel' ), /* Custom Type Description */
			'public' => true,
